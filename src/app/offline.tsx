            ...
            <div className="p-8 space-y-6">
              ...
              <div className="bg-amber-50 border-l-4 border-amber-400 p-5 rounded-r">
                <div className="flex items-start">
                  ...
                  <div className="flex-1">
                    <h3 className="text-sm font-semibold text-amber-800 mb-1">Connection Status</h3>
                    <p className="text-sm text-amber-700">
                      The Air Niugini Pilot Management System requires an active internet connection
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="bg-white rounded-lg border border-neutral-200 p-4">
                  ...
                  <p className="text-sm text-neutral-600 font-medium">No internet access</p>
                </div>
              </div>
