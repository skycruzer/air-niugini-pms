    ...
    <div className="min-h-screen bg-gradient-to-br from-neutral-50 to-neutral-100 flex items-center justify-center p-4">
      <div className="max-w-2xl w-full bg-white rounded-xl shadow-2xl overflow-hidden">
        ...
        <div className="p-8 space-y-6">
          {/* Gold Accent Box */}
          <div className="bg-[#06B6D4]/10 border-l-4 border-[#06B6D4] p-5 rounded-r">
          ...
          <div className="bg-neutral-50 rounded-lg p-5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <Link
                href="/dashboard"
                className="flex items-center gap-3 p-3 bg-white rounded-lg border border-neutral-200 hover:border-[#4F46E5] hover:shadow-md transition-all duration-200 group"
              >
                <div className="bg-[#4F46E5] group-hover:bg-[#4338CA] p-2 rounded-lg transition-colors">
