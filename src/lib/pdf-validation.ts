 ...
 */
export const PDFReportOptionsSchema = z
  .object({
...
export const ComplianceReportDataSchema = z.object({
  ...
  expiringCertifications: z.array(
    z.object({
      pilot: z.string(),
      employeeId: z.string(),
      checkType: z.string(),
...
export function validatePDFRequest(data: unknown) {
  try {
    ...
    throw new Error(
      `Invalid PDF request: ${error instanceof Error ? error.message : 'Unknown error'}`
    );
  }
}
...
export function validateComplianceReportData(data: unknown) {
  try {
    ...
    throw new Error(
      `Invalid compliance report data: ${error instanceof Error ? error.message : 'Unknown error'}`
    );
  }
}
...
export function validatePilotReportData(data: unknown) {
  try {
    ...
    throw new Error(
      `Invalid pilot report data: ${error instanceof Error ? error.message : 'Unknown error'}`
    );
  }
}
...
export function validateFleetManagementReportData(data: unknown) {
  try {
    ...
    throw new Error(
      `Invalid fleet management report data: ${error instanceof Error ? error.message : 'Unknown error'}`
    );
  }
}
...
export function validateReportType(reportType: unknown): string {
  try {
    ...
    throw new Error(
      `Invalid report type: ${reportType}. Must be one of: ${PDFReportTypeSchema.options.join(', ')}`
    );
  }
}
