...
export const PDFHeader: React.FC<PDFHeaderProps> = ({ metadata }) => (
  <View style={pdfStyles.header}>
    <View style={pdfStyles.headerLeft}>
      ...
      {metadata.subtitle && (
        <Text style={pdfStyles.reportSubtitle}>{metadata.subtitle}</Text>
      )}
    </View>
...
export const PDFFooter: React.FC<PDFFooterProps> = ({ pageNumber, totalPages }) => (
  <View style={pdfStyles.footer}>
    <Text style={pdfStyles.footerText}>
      Air Niugini Pilot Management System - Confidential
    </Text>
...
export const AlertBox: React.FC<AlertBoxProps> = ({ type, title, children }) => {
  ...
  return (
    <View style={[pdfStyles.alertBox, alertStyle]}>
      <Text style={[pdfStyles.alertTitle, { color: titleColor }]}>
        {title}
      </Text>
      <View style={pdfStyles.alertText}>
        {children}
      </View>
    </View>
  )
...
export const Section: React.FC<SectionProps> = ({ title, subtitle, children }) => (
  <View style={pdfStyles.section}>
    ...
    {subtitle && (
      <Text style={pdfStyles.sectionSubtitle}>{subtitle}</Text>
    )}
    {children}
  </View>
)
...
export const StatusBadge: React.FC<StatusBadgeProps> = ({ status, text }) => {
  ...
  return (
    <Text style={[statusStyles[status], pdfStyles.bold]}>
      {text}
    </Text>
  )
}