      ...
      <div className="max-w-2xl w-full bg-white rounded-xl shadow-2xl overflow-hidden">
        ...
        <div className="p-8 space-y-6">
          ...
          <div className="bg-red-50 border-l-4 border-[#4F46E5] p-4 rounded-r">
            <div className="flex items-start">
              ...
              <div className="flex-1">
                <h3 className="text-sm font-semibold text-[#4F46E5] mb-1">Error Message</h3>
          ...
          <div className="flex flex-col sm:flex-row gap-3 pt-4">
            <button
              ...
              className="flex-1 flex items-center justify-center gap-2 bg-[#4F46E5] hover:bg-[#4338CA] text-white px-6 py-3 rounded-lg font-semibold transition-colors duration-200 shadow-md hover:shadow-lg"
            >
          ...
          <div className="pt-4 border-t border-neutral-200">
            <button
              ...
              className="w-full flex items-center justify-center gap-2 bg-white hover:bg-neutral-50 text-neutral-800 px-6 py-3 rounded-lg font-medium border-2 border-neutral-300 hover:border-[#4F46E5] transition-all duration-200"
            >
          ...
          {process.env.NODE_ENV === 'development' && (
            <details className="mt-6">
              <summary className="text-sm font-semibold text-neutral-700 cursor-pointer hover:text-[#4F46E5] transition-colors">
        ...
        <div className="bg-neutral-100 px-8 py-4 border-t border-neutral-200">
          <div className="flex items-center justify-between text-xs text-neutral-600">
            ...
            <p className="text-[#4F46E5] font-semibold">Papua New Guinea&apos;s National Airline</p>
          </div>
        </div>
      </div>
    </div>
