...
export function CertificationCalendar({
  ...
  const eventsByDate = certifications.reduce(
    (acc, cert) => {
          ...
          {calendarDays.map((date) => {
            ...
            return (
              ...
              >
                ...
                {hasEvents && (
                  <>
                    <div className="absolute top-1 right-1 text-xs">{getStatusIcon(status)}</div>
                    {count > 1 && (
                    ...
                    <div
                      className={`px-2 py-1 rounded-full text-xs font-medium ${
                        monthStatus === 'expired'
                          ...
                          : monthStatus === 'expiring_soon'
                            ? 'bg-yellow-400 text-gray-900'
                            : monthStatus === 'due_soon'
