...
export function ViewToggle({ viewMode, onToggle, isLoading = false, className = '' }: ViewToggleProps) {
  return (
    <div className={`flex items-center border border-gray-300 rounded-lg p-1 bg-white ${className}`}>
      {/* Grid View Button */}
      <button
