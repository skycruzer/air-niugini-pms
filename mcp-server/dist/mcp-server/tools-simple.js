 ...
 */
export const greetingTool = tool('greeting', 'Get a greeting message for Air Niugini', {
 ...
 * Get pilot count
 */
export const getPilotCountTool = tool('get_pilot_count', 'Get the total number of pilots in the system', {}, async () => {
 ...
 */
export const getFleetStatsSimpleTool = tool('get_fleet_stats_simple', 'Get basic fleet statistics', {}, async () => {
    return {
        content: [
            {
                type: 'text',
