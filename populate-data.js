...
const checkTypes = [
  ...
  { check_code: 'OPC-B767', check_description: 'Operator Proficiency Check B767', category: 'Proficiency' },
  { check_code: 'LPC-B767', check_description: 'Line Proficiency Check B767', category: 'Proficiency' },
  ...
  { check_code: 'DANGER-GOODS', check_description: 'Dangerous Goods Training', category: 'Training' },
  ...
  try {
    ...
    if (testError) {
      ...
      testPilots.forEach(pilot =>
        console.log(`  - ${pilot.employee_id}: ${pilot.first_name} ${pilot.last_name} (${pilot.role})`)
      )
    }
