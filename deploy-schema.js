...
const supabaseServiceKey =
  'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6IndnZG1ndm9ucXlzZmx3ZGlpb2xzIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc1NTU4MjMyMCwiZXhwIjoyMDcxMTU4MzIwfQ.7tXqVwmgABgflVvKrcOHGlXd8JcN1yTvECfhJ0cWGRE'; // Service role key
...
async function deploySchema() {
  try {
    ...
    const migrationSQL = fs.readFileSync(
      path.join(__dirname, 'supabase-complete-migration.sql'),
      'utf8'
    );
